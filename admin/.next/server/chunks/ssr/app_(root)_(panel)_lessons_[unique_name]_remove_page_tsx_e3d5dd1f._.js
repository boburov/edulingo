...
"[project]/app/(root)/(panel)/lessons/[unique_name]/remove/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PlaylistRemovePage() {
    const [uniqueName, setUniqueName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [doesMatch, setDoesMatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function DeletePlaylist(e) {
        ...
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$services$2f$playlistsService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(playlist.unique_name);
            const resData = res;
            if (resData.deleted) {
                alert("Darslar toplami olib tashlandi!");
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$slices$2f$playlistSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePlaylist"])(playlist));
                router.push("/lessons");
            }
        } catch (err) {
...
//# sourceMappingURL=app_%28root%29_%28panel%29_lessons_%5Bunique_name%5D_remove_page_tsx_e3d5dd1f._.js.map